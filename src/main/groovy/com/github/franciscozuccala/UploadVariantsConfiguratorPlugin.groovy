...
class UploadVariantsConfiguratorPlugin implements Plugin<Project> {
...
//                          This generate pom with variant name, like decolar-debug
                            ...
                            actualPom.artifactId = "${project.uploadConfigurator.pomArtifactId}-$it"
                            actualPom.version = project.uploadConfigurator.pomVersion
                            actualPom.project {
